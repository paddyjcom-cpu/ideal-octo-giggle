...
// Temporarily commenting out components to test one by one
...
className={`w-full flex items-center gap-3 p-4 font-bold rounded-xl transition-colors ${ activeTab === 'dashboard'  ? 'bg-indigo-50 text-indigo-600'  : 'text-slate-600 hover:bg-slate-50' }`}
>
...
className={`w-full flex items-center gap-3 p-4 font-bold rounded-xl transition-colors ${ activeTab === 'inventory'  ? 'bg-indigo-50 text-indigo-600'  : 'text-slate-600 hover:bg-slate-50' }`}
>
<Package size={20} />
Inventory
</button>
